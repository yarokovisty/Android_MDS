...
import com.example.lab16.databinding.FragmentWolfBinding

class WolfFragment : Fragment() {
    private var _binding: FragmentWolfBinding? = null
    private val binding
        get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWolfBinding.inflate(inflater, container, false)
        return binding.root
    }
